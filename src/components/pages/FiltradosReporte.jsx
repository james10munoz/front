  ...
  const handleSubmit = async (e) => { 
    ...
    try {
        ...
        if (error.response) {
            ...
            // Intentar leer el Blob para más detalles
      ...
      <div className="w-full max-w-4xl bg-white shadow-lg rounded-lg p-8 mt-16 pl-52">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {tipoFecha === "dia" && (
              <div className="flex flex-col space-y-2">
                <label className="text-lg font-medium text-gray-800">Selecciona el Día de Nacimiento:</label>
                <DatePicker
                  selected={fechaDia}
            ...
            {tipoFecha === "mes" && (
              <div className="flex flex-col space-y-2">
                <label className="text-lg font-medium text-gray-800">Selecciona el Mes de Nacimiento:</label>
                <DatePicker
                  selected={fechaMes}
          ...
          <button
            type="submit"
            className="w-full py-3 bg-yellow-500 text-white font-bold rounded-lg shadow-md hover:bg-yellow-400 focus:outline-none focus:ring-2 focus:ring-yellow-500 transition duration-300"
          >
            Generar Reporte PDF
          </button>
        </form>
